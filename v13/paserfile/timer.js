...
rule.dayOfWeek = [0, new schedule.Range(0)];
rule.hour = 00
rule.minute = 30;
...
function start() {
    (async () => {
       ...
       const fs = require("fs");
       fs.writeFile(
           "/home/inmd/github/school-discord-bot/v13/paserfile/happy.json",
       ...
       fs.writeFile(
           '/home/inmd/github/school-discord-bot/v13/paserfile/hyomin.json',
